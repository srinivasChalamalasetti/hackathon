    ...
    <div>  
        <footer class="bg-blue-900 text-white">
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                ...
                <div class="mb-6 md:mb-0">
                    <a href="#/" class="flex items-center">
                        <img src={logo} class="h-8 me-3 rounded-2xl" alt="PrimeProperties Logo" />
                        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">PrimeProperties</span>
                    </a>
                </div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-white sm:text-center ">© 2024 <a href="#" class="hover:underline">PrimeProperties™</a>. All Rights Reserved.
                </span>
